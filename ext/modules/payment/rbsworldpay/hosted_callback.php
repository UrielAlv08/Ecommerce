...
*/
/*
  $_GET['installation'] = '8009483';
  $_POST['installation'] = '8009483';
  $_POST['callbackPW'] = 'ma5h~iZ455';
  $_POST['transStatus'] = 'Y';
  $_POST['M_hash'] = '8d815edecc166123f902abc235e4bc62';
  $_POST['M_sid'] = 'vhl308hoapaq0fupkhimv6n5b0';
  $_POST['M_cid'] = '222';
  $_POST['cartId'] = '234249';
  $_POST['M_lang'] = '';
  $_POST['M_paid'] = 'partlypaid';
  $_POST['amount'] = '2.60';
  $_POST['transId'] = '897237589273512345';
*/
  ...
  include('includes/languages/modules/payment/rbsworldpay_hosted.php');
...
<title><?php echo \common\helpers\Output::output_string_protected(TITLE); ?></title>
