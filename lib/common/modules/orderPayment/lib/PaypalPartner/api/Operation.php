...
class Operation extends PayPalResourceModel {
    
    public function __construct($data = null){
        $this->operation = PartnerConstants::OPERATION;
        parent::__construct($data);
    }
    
    public function setApiIntegrationPreference($preference)
    {
        $this->api_integration_preference = $preference;
        return $this;
    }
