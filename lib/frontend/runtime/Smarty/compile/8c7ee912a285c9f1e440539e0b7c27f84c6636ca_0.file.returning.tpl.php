...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.46',
  'unifunc' => 'content_63ca05a6f32da1_96334167',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8c7ee912a285c9f1e440539e0b7c27f84c6636ca' => 
    array (
...
function content_63ca05a6f32da1_96334167 (Smarty_Internal_Template $_smarty_tpl) {
...
<div class="login-box">
    ...
    <div class="middle-form">
        ...
        <?php $_prefixVariable1 = \common\helpers\Acl::checkExtensionAllowed('BusinessToBusiness','allowed');
$_smarty_tpl->_assignInScope('b2b', $_prefixVariable1);
if ($_prefixVariable1) {?>
...
<br><br>
        ...
        <?php $_prefixVariable2 = \common\helpers\Acl::checkExtensionAllowed('BusinessToBusiness','allowed');
$_smarty_tpl->_assignInScope('b2b', $_prefixVariable2);
if ($_prefixVariable2) {?>
            <?php  $_prefixVariable3 = $_smarty_tpl->tpl_vars['b2b']->value;
if ($_prefixVariable3::checkNeedLogin()) {?>
...
>
    function checkTerms(form) {
        <?php $_prefixVariable4 = \common\helpers\Acl::checkExtensionAllowed('BusinessToBusiness','allowed');
$_smarty_tpl->_assignInScope('b2b', $_prefixVariable4);
if ($_prefixVariable4) {?>
            <?php  $_prefixVariable5 = $_smarty_tpl->tpl_vars['b2b']->value;
if ($_prefixVariable5::checkNeedLogin()) {?>
