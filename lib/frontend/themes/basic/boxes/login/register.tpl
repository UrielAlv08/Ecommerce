...
{/if}
                ...
                {if in_array(ACCOUNT_CUSTOMS_NUMBER, ['required_register', 'visible_register'])}
                    <div class="col-right">
                        ...
                        {if ACCOUNT_CUSTOMS_NUMBER == 'required_register'}
                            {Html::activeTextInput($registerModel, 'customs_number', ['data-required' => "{$smarty.const.TEXT_CUSTOMS_NUMBER_ERROR}"])}
                        {else}
                            {Html::activeTextInput($registerModel, 'customs_number')}
                        {/if}
                    </div>
                {/if}
                ...
                <div class="password-row">
                    <div class="col-left">
                        ...
                        {Html::activePasswordInput($registerModel, 'password', ['class' => "password show-password", 'autocomplete' => "off", 'data-pattern' => "{$passDataPattern}", 'data-required' => "{$titleDataPattern}"])}
                    </div>
                    <div class="col-right">
                        <label for="confirmation">{field_label const="PASSWORD_CONFIRMATION" required_text="*"}</label>
                        {Html::activePasswordInput($registerModel, 'confirmation', ['class' => "confirmation show-password", 'autocomplete' => "off", 'data-required' => "{$smarty.const.ENTRY_PASSWORD_ERROR_NOT_MATCHING}", 'data-confirmation' => "#registration-password"])}
                    </div>
                </div>
                <div class="col-left">
