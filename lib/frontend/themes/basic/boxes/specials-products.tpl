...
<div class="heading-3">{$smarty.const.SPECIALS_PRODUCTS}</div>
...
<div class="view-all"><a href="{tep_href_link('catalog/sales')}" class="btn">{$smarty.const.VIEW_ALL_SPECIALS}</a></div>
