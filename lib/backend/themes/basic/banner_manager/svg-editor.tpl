...
<head>
    ...
    <script src="{$app->view->theme->baseUrl}/svg-editor/jquery-ui/jquery-ui-1.8.17.custom.min.js"></script>
    <script src="{$app->view->theme->baseUrl}/js/slick.min.js"></script>
    <script type="text/javascript" src="{$app->view->theme->baseUrl}/js/libs/dropzone.js"></script>

    <script type="text/javascript">
        window.setLangKey = '{$setLangKey}';
        window.tr = JSON.parse('{$tr}');
    </script>
    <script src="{$app->view->theme->baseUrl}/svg-editor/editor.js" defer="defer"></script>
    <link href="{$app->view->theme->baseUrl}/svg-editor/editor.css" rel="stylesheet" type="text/css" />
