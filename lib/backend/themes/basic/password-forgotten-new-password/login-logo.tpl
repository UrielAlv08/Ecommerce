{strip}<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
     viewBox="0 0 356 94" enable-background="new 0 0 356 94" xml:space="preserve" style="width: 330px">
<g display="none">
